...
/*********************************************************************************/
  ...
  var _settings = {
    ...
    // skelJS
      skelJS: {
        prefix: 'sites/all/themes/mcduck/css/style',
        resetCSS: true,
        boxModel: 'border',
        useOrientation: true,
        containers: 1140,
  ...
  // scrolly
    jQuery.fn.n33_scrolly = function(offset) {
      ...
      jQuery(this).click(function(e) {
        ...
        if (h.charAt(0) == '#' && h.length > 1 && (target = jQuery('section[data-id=' + h.substring(1, h.length) + ']')).length > 0)
        {
          var x, pos;
...
/*********************************************************************************/
  ...
  // jQuery
    jQuery(function() {
      ...
      // Call AJAX to load nodes
        // var nids = '';
        // var url = Drupal.settings.mcduck_commons.base_url + Drupal.settings.pathPrefix + '';
        // var request = $.ajax({
        //   url: url,
        //   type: 'POST',
        //   data: {
      ...
      // Replace href in main menu
        $(document).on('ready', function () {
          ...
          main_menu.find('> a').each(function() {
            ...
            {
              href_replacement = '#' + $this.attr('id');
              $this.attr('href', href_replacement);
            }
          });
        });
